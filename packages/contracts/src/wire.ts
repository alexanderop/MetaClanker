...
export const MessageRole = Schema.Literals(["user", "agent", "thought", "system"]);
...
export const PermissionOption = Schema.Struct({
  ...
  label: Schema.String,
  kind: Schema.Literals(["allow-once", "allow-always", "reject-once", "reject-always", "other"]),
});
...
export const CreateProjectRequest = Schema.Struct({
  commandId: CommandId,
  path: Schema.NonEmptyString,
  name: Schema.optionalKey(NonEmptyTrimmedString),
});
...
export const UpdateProjectRequest = Schema.Struct({
  ...
  order: Schema.optionalKey(Schema.Natural),
});
...
export const CreateThreadRequest = Schema.Struct({
  ...
  projectId: ProjectId,
  provider: Provider,
  title: Schema.optionalKey(NonEmptyTrimmedString),
...
export const CancelPromptRequest = Schema.Struct({
  commandId: CommandId,
});
export type CancelPromptRequest = typeof CancelPromptRequest.Type;
